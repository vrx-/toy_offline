...
!
      CALL wclock_on (ng, IDmod, 42, 190, "ROMS/Utility/get_state.F")
!
...
!
      ...
      IF (FoundError(exit_flag, NoError, 225,                           &
...
!
     ...
     &                      ncid = ncINPid)
      IF (FoundError(exit_flag, NoError, 277,                           &
     &               "ROMS/Utility/get_state.F")) RETURN
!
...
!
     ...
     &                        OCEAN(ng) % zeta(:,:,Tindex))
          END IF
          IF (FoundError(status, nf90_noerr, 582,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                      Fscl, Fmin, Fmax,                           &
     &                      OCEAN(ng) % rzeta)
          IF (FoundError(status, nf90_noerr, 702,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                        OCEAN(ng) % ubar(:,:,Tindex))
          END IF
          IF (FoundError(status, nf90_noerr, 749,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                        OCEAN(ng) % vbar(:,:,Tindex))
          END IF
          IF (FoundError(status, nf90_noerr, 827,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                      Fscl, Fmin, Fmax,                           &
     &                      OCEAN(ng) % rvbar)
          IF (FoundError(status, nf90_noerr, 858,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                      Fscl, Fmin, Fmax,                           &
     &                      OCEAN(ng) % ru)
          IF (FoundError(status, nf90_noerr, 934,                       &
     &                   "ROMS/Utility/get_state.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                          OCEAN(ng) % t(:,:,:,Tindex,itrc))
            END IF
            IF (FoundError(status, nf90_noerr, 1052,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
...
!
      CALL wclock_off (ng, IDmod, 42, 6343, "ROMS/Utility/get_state.F")
!
