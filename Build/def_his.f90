...
!
     ...
     &                   NF_FOUT, nvd3, u2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2364,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2383,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2421,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 4145,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 4153,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
      END IF DEFINE
!
!=======================================================================
...
!
        ...
        IF (FoundError(exit_flag, NoError, 4168,                        &
     &                 "ROMS/Utility/def_his.F")) THEN
...
!
     ...
     &                         ncid = HIS(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 4178,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
...
!
     ...
     &                       ncid = HIS(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 4185,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
