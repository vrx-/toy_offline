...
!
        ...
        IF (FoundError(exit_flag, NoError, 3593,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3601,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
      END IF DEFINE
!
!=======================================================================
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3616,                        &
     &                 "ROMS/Utility/def_avg.F")) THEN
...
!
     ...
     &                         ncid = AVG(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 3626,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!
...
!
     ...
     &                       ncid = AVG(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 3633,                        &
     &                 "ROMS/Utility/def_avg.F")) RETURN
!
