...
!
!svn $Id: set_diags.F 864 2017-08-10 04:11:10Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 5, 34, "ROMS/Utility/set_diags.F")
      CALL set_diags_tile (ng, tile,                                    &
     &                     LBi, UBi, LBj, UBj,                          &
     &                     IminS, ImaxS, JminS, JmaxS,                  &
     &                     kstp(ng),                                    &
     &                     nrhs(ng))
      CALL wclock_off (ng, iNLM, 5, 46, "ROMS/Utility/set_diags.F")
      RETURN
